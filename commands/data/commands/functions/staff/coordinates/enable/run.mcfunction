...
title @s actionbar [{"text":"","color":"gray"},{"text":"X: ","bold":true},{"score":{"name":"#current","objective":"position.x"},"color":"gold"},{"text":" Y: ","bold":true},{"score":{"name":"#current","objective":"position.y"},"color":"gold"},{"text":" Z: ","bold":true},{"score":{"name":"#current","objective":"position.z"},"color":"gold"}," ",{"nbt":"direction","storage":"player","bold":true}]