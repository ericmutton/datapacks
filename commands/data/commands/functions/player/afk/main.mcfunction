scoreboard players add @s[tag=!afk,scores={afk.timeout=..5999}] afk.timeout 1
...
execute unless entity @s[tag=!inMotion,tag=!inVoid,tag=!inCombat] if score @s[tag=!afk,scores={afk=0}] afk.timeout matches 6000 run function commands:player/afk/enable
execute unless entity @s[tag=!inMotion,tag=!inVoid,tag=!inCombat] if score @s[tag=!afk] afk matches 1.. run function commands:player/afk/enable
