...
tellraw @a[tag=home,scores={homes.max=2..},limit=1] [{"text":"You have returned to your ","color":"gray"},{"score":{"name":"#current","objective":"home"}},{"nbt":"text.ordinal","storage":"server"}," ",{"selector":"@s"}," home."]
