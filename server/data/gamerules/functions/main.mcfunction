...
execute if score $sleep gamerules matches 1 if entity @s[tag=player,nbt=!{SleepTimer:0s}] run function player:actions/sleep/run
# These gamerules have a complementary function for being enabled and disabled.
