...
execute if score #current int matches 3 run data modify storage minecraft:server text.ordinal set value "rd"
execute if score #current int matches 4.. run data modify storage minecraft:server text.ordinal set value "th"